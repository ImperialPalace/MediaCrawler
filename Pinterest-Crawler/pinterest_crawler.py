...
def main():
    ...
    parser.add_argument(
        "--keywords", help="keywords as path of file or list of words", nargs='+', default=[])
    parser.add_argument('--output', help='output dir',
                        default='./io/output', type=str)
    parser.add_argument("-nw", '--number-of-words',
                        help='number of keywords for search', default=2, type=int)
    ...
    for keyword in args.keywords:
        if os.path.isfile(keyword):
            ...
            keywords += [keyword.strip()
                         for keyword in file.read().split('\n')]
